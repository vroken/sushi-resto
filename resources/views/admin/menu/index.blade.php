                            ...
                            <tbody>
                                @foreach ($menus as $menu)                                    
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <span id="formattedPrice{{ $menu->id }}"></span>
                                        </td>
                                        <script>
                                        ...
                                        <td class="px-6 py-4 inline-block whitespace-nowrap overflow-hidden text-ellipsis" style="max-width: 20ch;">
                                            @foreach ($menu->categories as $category)
                                                {{ $category->name }}
                                                {{-- If this is not the last category, display a separator --}}
                                                @unless ($loop->last)
                                                    ,
                                                @endunless
                                            @endforeach
                                        ...
                                        <td
                                            ...
                                            <div class="flex space-x-2">
                                                ...
                                                <form
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('admin.menus.destroy', $menu->id) }}" class="btn btn-danger" data-confirm-delete="true">Hapus</a>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
